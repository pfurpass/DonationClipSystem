    ...
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboPlatform = new ComboBox
            {
                ...
                FlatStyle = FlatStyle.Flat, BackColor = input, ForeColor = Color.White
            };
            ...
            {
                Location = new Point(cx, y), Size = new Size(cw, 26),
                PasswordChar = '●', BackColor = input, ForeColor = Color.White,
            ...
            numMinDonation = new NumericUpDown
            {
                ...
                Minimum = 0, Maximum = 10000, DecimalPlaces = 2, Value = 5,
                BackColor = input, ForeColor = Color.White
            };
            ...
            {
                Text = "Spender schicken einen YouTube-Link\nin der Spendennachricht → wird\nautomatisch erkannt und abgespielt.\n\nTimestamps werden unterstützt:\nyoutu.be/ID?t=90",
                Location = new Point(lx, y), Size = new Size(292, 90),
            ...
            lblOverlayUrl = new Label
            {
                ...
                Location = new Point(lx, y), Size = new Size(210, 36),
            ...
            {
                Text = "Now Playing: —", Location = new Point(8, 376), Size = new Size(430, 20),
                ForeColor = silver, Font = new Font("Segoe UI", 8f), Parent = outerPlayer
            };
            lblQueueCount = new Label
            {
                Text = "Queue: 0", Location = new Point(450, 376), Size = new Size(100, 20),
                ForeColor = Color.FromArgb(255, 200, 0),
                Font = new Font("Segoe UI", 8f, FontStyle.Bold),
                TextAlign = ContentAlignment.MiddleRight, Parent = outerPlayer
            };
        ...
        private Button MakeBtn(string text, int x, int y, int w, int h)
        {
            ...
            {
                Text = text, Location = new Point(x, y), Size = new Size(w, h),
                FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(58, 58, 62),
        ...
        private static Label MakeSep(int x, int y, int w) =>
            new() { Location = new Point(x, y), Size = new Size(w, 1),
                    BackColor = Color.FromArgb(60, 60, 65), Text = "" };
    }
}
